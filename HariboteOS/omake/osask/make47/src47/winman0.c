/* "winman0.c":„Åê„ÅÑ„Åê„ÅÑ‰ªïÊßò„Ç¶„Ç£„É≥„Éâ„Ç¶„Éû„Éç„Éº„Ç∏„É£„Éº ver.3.9
		copyright(C) 2004 Â∑ùÂêàÁßÄÂÆü, I.Tak., Â∞èÊü≥ÈõÖÊòé, KIYOTO, nikq
    stack:64k malloc:4272k file:4160k */

/* 2004.08.13 „Çπ„ÇØ„É™„Éº„É≥„Ç∑„Éß„ÉÉ„Éà„ÇíBMPÂåñ
   8,15,16,32bpp„ÅßÊ≠£Â∏∏„Å™ÁîªÂÉè„ÅåÂèñ„Çå„Çã‚Ä¶‚Ä¶„ÅØ„Åö by I.Tak. */

/* 2004.09.10 ÁîªÈù¢Èñ¢‰øÇ„ÅÆglobalÂ§âÊï∞„ÇíÊßãÈÄ†‰Ωì„Å´„Åô„Çã„Åû
 * 2004.09.11 „Éá„Ç≥„Éº„ÉÄ„ÇíDLL‰ΩøÁî®„Å´„Åô„Çã„Åû‚Ä¶‚Ä¶„Åê„Å£pokon„ÅåÊ≠ª„Å¨„Åûtss=4000 EIP=2f10„Åß
 *            page fault„Å†„Çà‚Ä¶‚Ä¶mmareaÂàÜ„Åå‰∏çË∂≥„Åê„ÅØ„ÅÇ
 *            PICTURE0.BIN„ÅåSCRNSHOT.BMP (8bpp) „Çí„Éá„Ç≥„Éº„Éâ„Åß„Åç„Å™„ÅÑ(T_T
 */
#define int3 asm(".byte 0xcc")
#include <guigui00.h>
#include <sysgg00.h>
/* sysgg„ÅØ„ÄÅ‰∏ÄËà¨„ÅÆ„Ç¢„Éó„É™„ÅåÂà©Áî®„Åó„Å¶„ÅØ„ÅÑ„Åë„Å™„ÅÑ„É©„Ç§„Éñ„É©„É™
   ‰ªïÊßò„ÇÇ„Åã„Å™„ÇäÊµÅÂãïÁöÑ */
#include <stdlib.h>

/* „Éó„É™„Éó„É≠„Çª„ÉÉ„Çµ„ÅÆ„Ç™„Éó„Ç∑„Éß„É≥„Åß„ÄÅ-DPCAT„Åã-DTOWNS„ÇíÊåáÂÆö„Åô„Çã„Åì„Å® */

/* „Éè„Éº„Éâ„Ç≥„Éº„Éâ„ÄÇgas2nask„Éê„Éº„Ç∏„Éß„É≥„Ç¢„ÉÉ„ÉóÂæÖ„Å° */
...
static inline void call_dll0207_48(int *env, int *cmd)
{
  __asm__ 
    ("pushl %1\n"
     ...
     "addl $8, %%esp"		/* „Åì„Çå„ÇíÊúÄÈÅ©Âåñ„Åß„Åç„Å™„ÅÑ„ÅÆ„ÅåÊÆãÂøµ */
...
#if (defined(TOWNS))
	/* „Éû„Ç¶„ÇπÂ≠òÂú®flag (FMR<<4)|(R<<2)|L, 0:none,1:mouse,2:pad,3:6pad */
	static char townsmouse = 0x04;/* right mouse only */
	#if (defined(VMODE) || defined(CLGD543X))
	  #undef TWVSW        /* 1024„Åß„Å™„ÅÑ„Å®„Ç§„É≥„Çø„Éº„É¨„Éº„Çπ„Åß„Åç„Å™„ÅÑ */
	  #define TWVSW 1024  /* „Ç§„É≥„Çø„Éº„É¨„Éº„Çπ„Åó„Å™„ÅÑ„Å™„ÇâÂïèÈ°å„Å™„ÅÑ„Åå
                               * CLGD„Å´„ÅØ1024„ÅÆ„Éë„É©„É°„Éº„Çø„Åó„Åã‰Ωú„Å£„Å¶„Å™„ÅÑ */
	#endif
	#define FMRMOUSE 1    /* FMRMOUSE„Å´ÂØæÂøú 2004.04.12 by I.Tak. */
	#define KROM 1        /* font file „ÅåÁÑ°„ÅÑ„Å®„Åç„Å´ROM„Åß‰ª£Áî®„Åô„Çã 2004.04.12 by I.Tak. */
	#if (!defined(TWVSW))
		#define	TWVSW		1024
	#endif
...
/* NEC PC-98 „Åß„ÅØÂ§âÂåñ„Åó„Å™„ÅÑÂ§âÊï∞„Å´const„Çí„Å§„Åë, ÊúÄÈÅ©Âåñ„ÇíÊúüÂæÖ„Åô„Çã 
 * Â§âÊï∞„Åù„ÅÆ„ÇÇ„ÅÆ„ÅØÁÑ°„Åè„Å™„Çâ„Å™„ÅÑ„Åå („Éù„Ç§„É≥„ÇøÊ∏°„Åó„Åå„ÅÇ„Çä„ÅÜ„Çã„Åü„ÇÅ),
 * ÂèÇÁÖßÂõûÊï∞„ÅØÊ∏õ„Çã„ÅØ„Åö„Å†‚Ä¶‚Ä¶„Åì„Çì„Å™„Åì„Å®„Åô„ÇãÊÑèÂë≥„ÅÇ„Çã„ÅÆ„Åã */
...
#define free(addr)			for (;;); /* free„Åå„ÅÇ„Å£„Å¶„ÅØÂõ∞„Çã„ÅÆ„ÅßÊ∞∏‰πÖ„É´„Éº„Éó */
...
//	struct DEFINESIGNAL *ds1;
	...
	int tx0, ty0, tx1, ty1; /* „Ç¶„Ç£„É≥„Éâ„Ç¶ÁßªÂãï„ÅÆ„Åü„ÇÅ„ÅÆ„Çø„Éñ */
	int flags;
...
struct MOSWINSIG { /* 32bytes */
	...
	/* flags„ÅÆ‰∏ã‰Ωç4bit„ÅØlen */
	/* sig[4], sig[5]„ÅØÂ†¥Âêà„Å´„Çà„Å£„Å¶„ÅØx0, y0 */
};
...
static struct STR_JOB {
	...
	int *list, free, *rp, *wp;
	int count, int0;
	int movewin_x, movewin_y, movewin_x0, movewin_y0; /* ÁßªÂãïÂÖà„Å®ÁßªÂãïÂÖÉ */
	int readCSd10;
	void (*func)(int, int);
	struct WM0_WINDOW *win;
	int fonttss, sig;
...
int mouseaccel = 2;	/* „Åì„Çå„Çà„ÇäÂ§ß„Åç„ÅÑ„Å®Âä†ÈÄüÂ∫¶ÂÄçÂ¢ó */
int mousescale = 3; /* Âä†ÈÄü„Çπ„Ç±„Éº„É´„Å´„Åó„Çà„ÅÜ */
...
/* „Ç≠„ÉºÊìç‰ΩúÔºö
      F9:‰∏ÄÁï™‰∏ã„ÅÆ„Ç¶„Ç£„É≥„Éâ„Ç¶„Å∏
      F10:‰∏ä„Åã„ÇâÔºíÁï™ÁõÆ„ÅÆ„Ç¶„Ç£„É≥„Éâ„Ç¶„ÇíÈÅ∏Êäû
      F11:„Ç¶„Ç£„É≥„Éâ„Ç¶„ÅÆÁßªÂãï
      F12:„Ç¶„Ç£„É≥„Éâ„Ç¶„ÇØ„É≠„Éº„Ç∫ */
...
/* ÂÖ•ÂäõÊñπÊ≥ï„ÉÜ„Éº„Éñ„É´(2ÈÄö„Çä„Åæ„Åß„Çµ„Éù„Éº„Éà) */
static struct KEYTABLE {
	...
	unsigned char rawcode1, shifttype1;
		...
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xda' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xdb' */,
		{ 0x67, NOSHIFT, 0xff, 0xff    } /* 'Ë¶™Êåá„Ç∑„Éï„ÉàÂ∑¶' */,
		{ 0x68, NOSHIFT, 0xff, 0xff    } /* 'Ë¶™Êåá„Ç∑„Éï„ÉàÂè≥' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xde' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xdf' */,
/* e0ÔΩûf7„ÅØ„ÄÅÂâ≤„ÇäÂΩì„Å¶„Çã„ÅÆ„ÅåÈù¢ÂÄí„Å´„Å™„Å£„ÅüÊ©üÁ®ÆÂõ∫Êúâ„ÅÆ„Éû„Ç§„Éä„Éº„Ç≠„Éº */
		{ 0x72, NOSHIFT, 0xff, 0xff    } /* ÂèñÊ∂à */,
		{ 0x73, NOSHIFT, 0xff, 0xff    } /* ÂÆüË°å */,
		{ 0x59, NOSHIFT, 0xff, 0xff    } /* „Åã„Å™Êº¢Â≠ó */,
		{ 0x4a, NOSHIFT, 0xff, 0xff    } /* 000 */,
		{ 0x6b, NOSHIFT, 0xff, 0xff    } /* Êº¢Â≠óËæûÊõ∏ */,
		{ 0x6c, NOSHIFT, 0xff, 0xff    } /* ÂçòË™ûÊäπÊ∂à */,
		{ 0x6d, NOSHIFT, 0xff, 0xff    } /* ÂçòË™ûÁôªÈå≤ */,
		{ 0x6a, NOSHIFT, 0xff, 0xff    } /* Ëã±Â≠ó */,
		{ 0x6f, NOSHIFT, 0xff, 0xff    } /* „Ç´„Çø„Ç´„Éä/Ëã±Â∞èÊñáÂ≠ó */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xe9' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xea' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xeb' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xec' */,
		...
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xf6' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xf7' */,
/* f8ÔΩûff„ÅØ„ÄÅ„Éû„Ç§„Éä„Éº„Ç∑„Éï„Éà„Ç≠„Éº */
		{ 0x67, NOSHIFT, 0x68, NOSHIFT } /* Ë¶™Êåá„Ç∑„Éï„Éà('\xf8') */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xf9' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xfa' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xfb' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xfc' */,
...
/* f8OSHIFT } /* '-' */,
		...
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xde' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xdf' */,
/* e0Å`f7ÇÕÅAäÑÇËìñÇƒÇÈÇÃÇ™ñ ì|Ç…Ç»Ç¡ÇΩã@éÌå≈óLÇÃÉ}ÉCÉiÅ[ÉLÅ[ */
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xe0' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xe1' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xe2' */,
		{ 0xff, 0xff,    0xff, 0xff    } /* '\xe3' */,
...
void OsaskMain()
{
	...
	struct MOSWINSIG *mws;
		...
		static int TOWNS_mouseinit[] = {
			...
			20 /* ÉTÉìÉvÉäÉìÉOÉåÅ[Ég 20É~Éäïb */,
			0, 0, /* TAPIÇÃÉVÉOÉiÉãèàóùÉxÉNÉ^(TAPI_SignalMessageTimer) */
	...
	// ÉEÉBÉìÉhÉEÇämï€ÇµÇƒÅAëSÇƒñ¢égópÉEÉCÉìÉhÉEÇ∆ÇµÇƒìoò^
	...
	// ÉTÉEÉìÉhÉgÉâÉbÉNópÉoÉbÉtÉ@ÇÃèâä˙âª
	...
	*(pjob->rp = pjob->wp = pjob->list) = 0; /* ÇΩÇ‹Ç¡ÇΩédéñÇÕÇ»Ç¢ */
	...
	close_all:
		...
		case 0x0024:
			/* ÉEÉBÉìÉhÉEÉNÉçÅ[ÉYóvêø(handle) */
			win = handle2window(signal[1]);
			siglen++; /* siglen = 2; */
			if ((win->flags & 0x01) == 0) {
				win->flags |= 0x01; /* ÉNÉçÅ[ÉYèàóùíÜ */
		...
		case 0x0028:
			/* ÉEÉBÉìÉhÉEÉAÉNÉeÉBÉuóvêø(opt, handle) */
			goto mikannsei;

		case 0x002c:
			/* ÉEÉBÉìÉhÉEòAìÆÉfÉoÉCÉXéwíË
		...
		case 0x0030:
			...
			if ((sig4 & 0xff) == 0x12 && mx != 0x80000000)
				mousesignal(mbutton, 0, 0); /* eyeÇ»Ç«ÇÃÇΩÇﬂ */
			break;

		case 0x0040: /* open sound track (slot, tss, signal-base, reserve0, reserve1)
			   éÛóùÇµÇΩÇ±Ç∆ÇímÇÁÇπÇÈÇΩÇﬂÇ…ÅAÉVÉOÉiÉãÇ≈âûìöÇ∑ÇÈ */
		//	sndtrk = alloc_sndtrk();
	...
	sndtrk_sendactsig:
		...
		//	free_sndtrk(sndtrk);
			...
			if (sndtrk == sndtrk_active) {
				...
				if (sndtrk_active = sndtrk)
					goto sndtrk_sendactsig; /* ÉAÉNÉeÉBÉuÉVÉOÉiÉãÇëóÇÈ */
			}
			break;
		...
		case 0x0052:
		case 0x0053:
		case 0x0054: /* 0x005fÇ‹Ç≈ÇÕÉäÉUÅ[Éu */
		...
		case 0x0014: /* âÊñ ÉÇÅ[ÉhïœçXäÆóπ(result) */
		case 0x00c0: /* çXêVí‚é~ÉVÉOÉiÉã(handle) */
		case 0x00c4: /* ï`âÊäÆóπÉVÉOÉiÉã(handle) */
		//	i = signal[0];
			j = signal[1];
			siglen++; /* siglen = 2; */
			(*pjob->func)(i, j);
		...
		case 0x0220:	/* PF13ÇæÇØÇ«ÅcÅc0x210Ç≈ÇÕÇ‹Ç∏Ç¢Ç» */
		case 0x0221:	/* PF14 */
			//	siglen = 1;
			/* HW code(5430=0x100, 5434=0x200, none=0) Ç™ï‘Ç¡ÇƒÇ≠ÇÈ */
		  if (pf13mode < 0)
		...
		case 0x0300: /* townsmouse */
			...
			#if (defined(PCAT))
		case 0x10001 /* âpåÍÉLÅ[É{Å[ÉhÇ…ïœçX */:
			//	siglen = 1;
				for (i = 0; i < 20; i++) {
	...
	//		break;
		...
		default:
		mikannsei:
		//	lib_drawline(0x0020, (void *) -1, 0, 0, 0, 15, 15); /* Ç±Ç±Ç…óàÇΩÇ±Ç∆ÇímÇÁÇπÇÈ */
		//	siglen = 1;
			;
		}
		if (siglen) {
...
void chain_unuse(struct WM0_WINDOW *win)
{
	...
	if (win->sgg.handle) {
		...
		/* init.askÇ…ÅAäYìñÇÃÉnÉìÉhÉãÇ™ÉtÉäÅ[Ç≈Ç†ÇÈÇ±Ç∆Çã≥Ç¶ÇÈÇΩÇﬂ */
		static int zero = 0;
		sgg_directwrite(0, 4, 0, win->sgg.handle, 0x01280030 /* stack_sel */, &zero, 0x000c);
		win->sgg.handle = 0; // handle2windowÇ™ä‘à·Ç¡ÇƒåüèoÇµÇ»Ç¢ÇΩÇﬂÇ…
	}
	if (unuse) {
...
*/
	if ((header >> 28) == 0x0 /* normal mode */) {
		...
		if (mbutton == (nbutton = header & 0x07)) { /* É}ÉEÉXÇÃÉ{É^ÉìèÛë‘ÇÕïsïœ */
			if (nbutton | mbutton) { /* ÉhÉâÉbÉOíÜ */
				flagmask |= 0x02;
				goto send0;
			}
			/* í èÌÇÃÉ}ÉEÉXà⁄ìÆíÜ */
	...
	send1:
			...
			if ((mbutton & 0x01) == 0x01 && (nbutton & 0x01) == 0x00 && press->pos != NO_PRESS) {
				mousesignal_sub0(_mx, _my); /* ç∂É{É^ÉìÇ™ï˙Ç≥ÇÍÇΩ */
				press->pos = NO_PRESS;
			}
			flagmask |= 0x03;
			if (mbutton != 0)
				goto send0;
			/* ÉvÉåÉXèÛë‘ÇÃóßÇøè„Ç™ÇË */
			win = searchwin(_mx, _my);
			if (top != win) {
			...
			if ((nbutton & 0x01) != 0 && press->win != NULL)
				mousesignal_sub1(_mx, _my); /* ç∂É{É^ÉìÇ™âüÇ≥ÇÍÇΩ */
			goto send1;
		}
skip:
		mbutton = nbutton;
	...
	/* ó≠Ç‹Ç¡ÇΩÉWÉáÉuÇ™Ç†ÇÍÇŒÅAé¿çsÇ∑ÇÈ */
	if (pjob->now == 0)
		runjobnext();
	return;
}
...
void mousesignal_sub1(int _mx, int _my)
/* ç∂É{É^ÉìÇ™âüÇ≥ÇÍÇΩÇ∆Ç´ÇÃëgÇ›çûÇ›ÉCÉxÉìÉg */
{
	struct STR_JOB *pjob = &job;
	struct STR_PRESS *press = &press0;
	...
	#elif (defined(NEWSTYLE)) /* ÉNÉçÅ[ÉYÉ{É^ÉìÇÕÇ†ÇËÇ‹ÇπÇÒ */
...
void mousesignal_sub0(int _mx, int _my)
/* ç∂É{É^ÉìÇ™ï˙Ç≥ÇÍÇΩÇ∆Ç´ÇÃëgÇ›çûÇ›ÉCÉxÉìÉg */
{
	struct STR_JOB *pjob = &job;
	struct STR_PRESS *press = &press0;
	struct WM0_WINDOW *win = press->win;
...
void job_openwin0(struct WM0_WINDOW *win)
{
	...
	if (top == NULL) {
		...
		win->x0 &= ~(screen.moveunit - 1); // ÉIÅ[ÉvÉìà íuÇ8ÇÃî{êîÇ…Ç»ÇÈÇÊÇ§Ç…í≤êÆ
		for (i = 0; i < MAXWINDEF - 1; i++) {
	...
	// äeéÌÉpÉâÉÅÅ[É^Å[ÇÃèâä˙âª
	win->x1 = win->x0 + xsize;
	win->y1 = win->y0 + ysize;
	win->job_flag0 = WINFLG_MUSTREDRAW | WINFLG_OVERRIDEDISABLED; // override-disable & must-redraw

	// ì¸óÕÉAÉNÉeÉBÉuÇïœçX
	redirect_input(win); // Ç±ÇÃä÷êîÇÕÅAÉEÉBÉìÉhÉEêßå‰ÇÕÇµÇ»Ç¢
//	iactive = win;
	...
	sgg_wm0s_setstatus(&win->sgg, win->condition = 0x03 /* bit0:ï\é¶, bit1:ì¸óÕ */);
	job_general1();
	return;
}
...
void redirect_input(struct WM0_WINDOW *win)
{
	// ÉLÅ[ì¸óÕÉVÉOÉiÉãÇÃëŒâûÇ√ÇØÇèâä˙âª
//	sgg_wm0_definesignal0(255, 0x0100, 0);
//	sgg_wm0_definesignal3com();
	sgg_execcmd(&defbindcommand);

	// winman0ÇÃÉLÅ[ëÄçÏÇìoò^(F9Å`F12)
	sgg_wm0_definesignal3(3, 0x0100, 0x00701089 /* F9Å`F12 */,
	...
	sgg_wm0_definesignal3(0, 0x0100, 0x00701085 /* F5 */,
		0x3240 /* winman0 signalbox */, 0x7f000001, 0x0240); /* JPN16$.FNTÇÃë¶éûÉçÅ[Éh */
	...
	#endif
	#if (defined(NEC98))
		sgg_wm0_definesignal3(1, 0x0100, 0x20701089 /* Ctrl+F9Å`F10 */,
...
void job_activewin0(struct WM0_WINDOW *win)
{
	...
	if (top == win) {
		/* topÇ∆iactiveÇÕèÌÇ…ìôÇµÇ¢ */
		job.now = 0;
		return;
	}

	/* winÇÉäÉXÉgÇ©ÇÁàÍìxêÿÇËó£Ç∑ */
	win_up = win->up;
	win_down = win->down;
...
void job_movewin0(struct WM0_WINDOW *win)
{
	// winÇÕÅAïKÇ∏topÇ≈ÅAÇ©Ç¬ÅAiactiveÇ≈Ç†ÇÈÇ±Ç∆
	struct STR_JOB *pjob = &job;

	pjob->win = top /* win */;

	/* Ç«Ç§Çπçƒï`âÊÇ∑ÇÈÇÃÇæÇ©ÇÁ0Ç…ÇµÇƒÇµÇ‹Ç§ÅB
	   ïKÇ∏0Ç…ÇµÇƒÇ®Ç©Ç»Ç¢Ç∆, ÉEÉBÉìÉhÉEÇè¡ÇµÇƒÇ¢ÇÈç≈íÜÇ…
	   ï`âÊÇ≥ÇÍÇΩÇËÇµÇƒÇ‚Ç¡Ç©Ç¢ÇæÅBè¡Ç∑íºëOÇ…ï`âÊã÷é~Ç…
	   Ç∑ÇÈéËÇ‡Ç†ÇÈÇ™ÅB*/
	win->condition = 0;
	pjob->count = 1;
...
//	sgg_wm0_definesignal3com();
	...
	// Ç∆ÇËÇ†Ç¶Ç∏ÅAëSÇƒÇÃÉEÉBÉìÉhÉEÇÃâÊñ çXêVå†ÇàÍéûìIÇ…îçíDÇ∑ÇÈ
	pjob->count = 0;
	win = top;
	pjob->func = job_movewin1;
	do {
...
//	à»â∫ÇÕê¨óßÇµÇ»Ç¢(ç≈í·àÍÇ¬ÇÕèoóÕÉAÉNÉeÉBÉuÇ»ÉEÉBÉìÉhÉEÇ™ë∂ç›Ç∑ÇÈÇ©ÇÁ)
//	if (pjob->count == 0) {
//		job_movewin2(); // Ç∑ÇÆÇ…ÉEÉBÉìÉhÉEògï\é¶Ç÷
//	}
...
void job_movewin2()
{
	...
	// ÉVÉOÉiÉãÇêÈåæ(0x00d0Å`0x00d3, 0x00f0)
...
void job_movewin4(int sig)
{
	...
	//	win0->job_flag0 = WINFLG_MUSTREDRAW | WINFLG_OVERRIDEDISABLED; // override-disabled & must-redraw
		...
		//	win1->job_flag0 = flag0;
			...
			/* ç≈èâÇ©ÇÁï`âÊã÷é~Ç≈, ÉWÉáÉuèIóπå„Ç‡ï`âÊã÷é~
			   ÇÃÉEÉBÉìÉhÉEÇÕjob_generalÇ≈ÇÕçƒï`âÊÇ≥ÇÍÇ»Ç¢ */
...
/* ÉEÉBÉìÉhÉEògï`âÊÇÃëOÇ…ìñÇΩÇËîªíËÇÇµ, ï`âÊã÷é~Ç‚ç∑ï™ï`âÊÇî≠çsÇ∑ÇÈÅB
   ÉVÉOÉiÉãî≠çsêîÇï‘Ç∑ÇÃÇ≈, ï‘ÇËílÇ™îÒóÎÇ»ÇÁÉVÉOÉiÉãÇë“Ç¬Ç±Ç∆ÅB */
int job_movewin5()
{
	struct STR_JOB *pjob = &job;
	struct WM0_WINDOW *win = pjob->win;
...
/* ï`âÊã÷é~Ç»Ç«Ç™ëSÇƒéÛêMÇ≥ÇÍÇΩÇÁògÇï`Ç≠ */
void job_movewin6(const int cmd, const int handle)
{
	if ((cmd & 0x00c3) != 0x00c0)
		return;
	// 0x00c0Ç©0x00c4ÇµÇ©Ç±Ç»Ç¢
	if (--job.count == 0)
		job_movewin3();
	return;
}
...
void job_closewin0(struct WM0_WINDOW *win0)
// Ç±ÇÃÉEÉBÉìÉhÉEÇÕä˘Ç…accessdisableÇ…Ç»Ç¡ÇƒÇ¢ÇÈÇ±Ç∆Ç™ëOíÒ
{
	struct STR_JOB *pjob = &job;
...
//	pjob->func = job_closewin1;
	...
	/* ç≈èâÇ©ÇÁï`âÊã÷é~Ç≈, ÉWÉáÉuèIóπå„Ç‡ï`âÊã÷é~
	   ÇÃÉEÉBÉìÉhÉEÇÕjob_generalÇ≈çƒï`âÊÇ≥ÇÍÇ»Ç¢ (Jenny1.2) */
	/* è„ãLèåèÇ…äYìñÇ∑ÇÈÉEÉBÉìÉhÉEÇÕÇ†ÇËÇ¶Ç»Ç¢ãCÇ™Ç∑ÇÈÇÃÇ≈ÅA
		I.Tak.Ç≥ÇÒÇÃÇªÇÃîªíËïîï™ÇéEÇµÇƒÇ›ÇÈÅB by K, Twitchell1 */
	win1 = top;
	do {
		/* deleted by I.Tak. (Jenny1.2) */
	//	int flag0 = 0;
...
// ÉEÉBÉìÉhÉEè¡ãéÇÃèÍçáÅAè¡ÇµÇΩÇ¢ÉEÉBÉìÉhÉEÇ∆èdÇ»Ç¡ÇƒÇ¢ÇÈÇ‡ÇÃÇëSÇƒ"must-redraw"Ç…ÇµÇΩÇ†Ç∆
// ÉEÉBÉìÉhÉEÇè¡ÇµÅAÇ†Ç∆ÇÕé©ìÆÇ…îCÇπÇÈ

// ÉEÉBÉìÉhÉEÉIÅ[ÉvÉìÇÃèÍçáÅAí«â¡ÇµÇƒÅAå„ÇÕé©ìÆÇ…îCÇπÇÈ

// ÉEÉBÉìÉhÉEà⁄ìÆÇÃèÍçáÅAà⁄ìÆå≥Ç∆èdÇ»Ç¡ÇƒÇ¢ÇÈÇ‡ÇÃÇëSÇƒ"must-redraw"Ç…ÇµÇΩÇ†Ç∆
// Ç‡Ç∆Ç¢ÇΩèÍèäÇè¡ÇµÅAÇ†Ç∆ÇÕé©ìÆÇ…îCÇπÇÈ
...
/* condition.bit 0 ... 0:accessdisable 1:accessenable
   ...
   conditionÇÕjobÇ…ì¸ÇÈëOÇÃèÛë‘
   job_flag0ÇÃëŒâûÇ∑ÇÈÉrÉbÉgÇÕjobèIóπå„ÇÃèÛë‘ (Ç…Ç»ÇÈÇÊÇ§Ç…åvéZÇµÇ»Ç®Ç∑)
   job_flag0ÇÃOVERRIDEDISABLED ÇÕ, Ç∆Ç…Ç©Ç≠åªç›ÇÃï`âÊã÷é~èÛë‘ */
{
	struct STR_JOB *pjob = &job;
	struct WM0_WINDOW *win0, *win1, *bottom, *top_ = top /* çÇë¨âªÅAÉRÉìÉpÉNÉgâªÇÃÇΩÇﬂ */;
	int flag0;
	...
	/* topÇÕjob_flag0.bit 1 = 1; */
	top_->job_flag0 |= 0x02; /* input-active */

	/* â∫Ç©ÇÁå©ÇƒÇ¢Ç¡ÇƒÅAconditionÇ™ïœâªÇ∑ÇÈó\íËÇ»ÇÁ (ç∑ï™) çƒï`âÊ
	   ÇªÇÃÇ∆Ç´é©ï™Ç…èdÇ»Ç¡ÇƒÇ¢ÇÈè„ÇÃÇ‚Ç¬ëSÇƒÇ‡çƒï`âÊ */
	/* ÇªÇÍÇ‹Ç≈ï`âÊãñâ¬Ç≈Ç†Ç¡ÇΩÇ»ÇÁ, ç∑ï™ï`âÊÇ≈çœÇ‹ÇπÇÈ */
	pjob->count = 0;	/* added by I.Tak. (Jenny1.2) */
	pjob->func = job_general2;	/* added by I.Tak. (Jenny1.2) */
	win0 = bottom = top_->up; /* àÍî‘è„ÇÃè„ÇÕÅAàÍî‘â∫ */
	do {
		...
		if ((flag0 & (WINFLG_OVERRIDEDISABLED | 0x01)) == (WINFLG_OVERRIDEDISABLED | 0x01)
			...
			if (win0->condition & 1)
				...
				/* çƒï`âÊÇ∆ç∑ï™ï`âÊÇ™ìØéûÇ…óßÇ¬Ç±Ç∆Ç‡Ç†ÇÈÇØÇ«
				   çƒï`âÊÇóDêÊÇ∑ÇÈÇÊÇ§Ç…Ç»Ç¡ÇƒÇ¢ÇÈ */
			win0->job_flag0 = flag0;
		}
		if (flag0 & WINFLG_MUSTREDRAW) {
			for (win1 = win0->up; win1 != bottom; win1 = win1->up) {
				if ((win1->job_flag0 & WINFLG_MUSTREDRAW) == 0) { /* Ç±ÇÃifï∂Ç™Ç»Ç≠ÇƒÇ‡é¿çsåãâ ÇÕïœÇÌÇÁÇ»Ç¢Ç™ÅAçÇë¨âªÇÃÇΩÇﬂ */
					if (overrapwin(win0, win1))
...
#if 0	/* deleted by I.Tak. (Jenny1.2) */
	/* redrawÇó\íËÇµÇƒÇ¢ÇÈÉEÉBÉìÉhÉEÇ≈ÅAëºÇÃredrawó\íËÉEÉBÉìÉhÉEÇ∆ÉIÅ[ÉoÅ[ÉâÉbÉvÇµÇƒÇ¢ÇÈÇ‡ÇÃÇÕÅA
		ëSÇƒoverride-accessdisabledÇ…Ç∑ÇÈ */
	pjob->count = 0;
...
void job_general2(const int cmd, const int handle)
{
	...
	if (cmd != 0 || handle != 0) {
		...
		if (cmd == 0x00c0 /* çXêVí‚é~éÛóùÉVÉOÉiÉã */) {
...
error:
		...
		} else if (cmd == 0x00c4 /* ï`âÊäÆóπÉVÉOÉiÉã */) {
	...
	if (win == top && win->job_flag0 == 0)
		goto fin;
		/* ÇPé¸ñ⁄Ç≈win->job_flag0Ç™0Ç…Ç»ÇÈÇ±Ç∆Ç‡Ç†ÇËÇ§ÇÈ */
		// ëSÇƒÇÃçÏã∆Ç™äÆóπ
	if (win == NULL)
		win = top;
...
void gapi_driverinit(int drv)
{
	...
	static union {
		...
		int align;
			...
			S _ _ _ _ _ _ _ _ T _ _ _ _ _ _ _ _
		#elif (defined(TMENU))
			/* ÉIÉäÉWÉiÉãÉ}ÉEÉXÉJÅ[É\ÉãÉpÉ^Å[Éì(16x16, mono) by I.Tak. */
			/* TOWNS ÇÃì‡ëüÇ…ì¸Ç¡ÇƒÇÈÇ‡ÇÃÇ…éóÇπÇƒÇ¢Ç‹Ç∑Ç™ÉtÉãÉXÉNÉâÉbÉ`Ç≈Ç∑ÅB*/
			...
			S _ _ _ _ _ _ _ _ T _ _ _ _ _ _ _ _
		#elif (defined(WIN31))
			/* â¸ë¢çœÇ›É}ÉEÉXÉJÅ[É\ÉãÉpÉ^Å[Éì(16x16, mono) by êπêl */
			S O O _ _ _ _ _ _ T _ _ _ _ _ _ _ _,
			S O _ O _ _ _ _ _ T _ _ _ _ _ _ _ _,
			S O _ _ O _ _ _ _ T _ _ _ _ _ _ _ _,
			S O _ _ _ O _ _ _ T _ _ _ _ _ _ _ _,
	...
	// closeÇ∑ÇÈéûÇ…Ç∑Ç◊ÇƒÇÃÉEÉBÉìÉhÉEÇÕdisableÇ…Ç»Ç¡ÇƒÇ¢ÇÈÇÕÇ∏Ç»ÇÃÇ≈ÅA
	// Ç±Ç±Ç≈ÇÕdisableÇ…ÇÕÇµÇ»Ç¢

	#if (defined(PCAT))
		/* sggÇ≈ÉhÉâÉCÉoêÿÇËë÷Ç¶ÇéwíË */
		...
		if (screen.vbecoldep != drv)
			screen.wallpaper_exist = 0;
		screen.vbecoldep = drv;	/* è„à Ç…ì¸Ç¡ÇƒÇ¢ÇÈÉ`ÉbÉvèÓïÒÇÕ */
		screen.driver = drv >> 8; /* Ç±Ç±Ç…ï€ë∂ */
	#endif
...
void job_setvgamode0(const int mode)
{
	...
	if (pjob->count == 0)
		job_setvgamode2(); // Ç∑ÇÆÇ…ÉfÉBÉXÉvÉåÅ[ÉÇÅ[ÉhïœçXÇ÷
...
void job_setvgamode2()
{
	struct WM0_WINDOW *win;
		...
		/* drvcode: TOWNS15 = 0x002, VESA16 = 0x102/0x202 Ç∆ÇµÇΩÅB
		 * job.int0ÇÕâÊñ ÉÇÅ[Éhî‘çÜ 0,1,2,3, 0x101, 0x102 ÇÃÇ«ÇÍÇ©ÅB
		 * gapi_drvinit (sgg(0x0088)) Ç…ÇÕdrvcodeÇó^Ç¶ÇÈÅB
		...
		if (newmode == 4)
		  newdrv &= 0xff; /* CL8bppÇÕTOWNSÉlÉCÉeÉBÉîã§ópÉhÉâÉCÉo */
		newdrv |= bpp[newmode];

		if ((width[newmode] < screen.x2 || height[newmode] < screen.y2) && (win = top)) {
			/* ëSÉEÉBÉìÉhÉEÇÃç¿ïWîÕàÕÇämîF(ÇÕÇ›èoÇµÇΩÇÁâÊñ ÇêÿÇËë÷Ç¶Ç»Ç¢) */
			do {
		...
		/* âÊñ ÉÇÅ[Éh0ê›íË(640x480x8bpp) */
		/* âÊñ ÉÇÅ[Éh1ê›íË(768x512x8bpp) */
		/* âÊñ ÉÇÅ[Éh2ê›íË(640x480ÉrÉfÉI) */
		/* âÊñ ÉÇÅ[Éh3ê›íË(512x480x16bpp) */
		/* âÊñ ÉÇÅ[Éh4ê›íË(1024x768x8bpp CLGD543x) */
		/* âÊñ ÉÇÅ[Éh5ê›íË(800x600x16bpp CLGD543x) */
		...
		/* GAPIç∑Çµë÷Ç¶ vesa16ÇÃÇ∆Ç´ÇÕâÊñ ÉÇÅ[ÉhïœçXÇ‡ìØéûÇ…Ç‚ÇÈ */
		gapi_driverinit(newdrv);
		if ((newdrv & 0xff) == 2) /* towns15/vesa16Ç…x2,y2ÇímÇÁÇπÇÈ */
		  sgg_execcmd0(0x0050, 8 * 4, 0x001c, 0, 0x0020, screen.x2, screen.y2, 0x0000, 0x0000);
		else
		  sgg_execcmd0(0x0050, 7 * 4, 0x001c, 0, 0x0020, job.int0 /* mode */, 0x0000, 0x0000); /* âÊñ ÉÇÅ[ÉhïœçX */
 		if (job.int0 < 3)
 			sgg_wm0_gapicmd_001c_0004(); /* ÉnÅ[ÉhÉEÉFÉAèâä˙âª(ÉpÉåÉbÉgê›íË) */
		#if (defined(CLGD543X))
			/* ïsóvÇ»Ç∆Ç´Ç‡ëΩÇ¢ÇÃÇæÇ™ÅcÅc */
			sgg_execcmd0(0x0088, 1, job.int0, 0x0000); /* VRAM&CRTèoóÕ êÿë÷Ç¶ */
		#endif
		...
		#if (defined(BOCHS))
			screen.x2 = 640; /* BochsÇÕâºëzâÊñ Ç™égÇ¶Ç»Ç¢ */
			screen.y2 = 480;
		#else
			screen.x2 = 800;
			screen.y2 = 600;
		...
		if (fromboot & 0x0001) {
			/* ïÅí ÇÃï˚ñ@Ç™égÇ¶Ç»Ç¢ */
			/* (âºëz86ÉÇÅ[ÉhÇ≈ÇÃVGAÉÇÅ[ÉhêÿÇËä∑Ç¶Ç™Ç§Ç‹Ç≠çsÇ©Ç»Ç¢) */
		//	x2 = 640;
		//	y2 = 480;
		//	sgg_wm0_gapicmd_001c_0020(); // âÊñ ÉÇÅ[Éhê›íË(640x480)
			sgg_execcmd0(0x0050, 7 * 4, 0x001c, 0, 0x0020, 0x0012, 0x0000, 0x0000);
			sgg_wm0_gapicmd_001c_0004(); // ÉnÅ[ÉhÉEÉFÉAèâä˙âª
			init_screen(screen.x2, screen.y2);
			job_general1();
			return;
		}
		if (lock_v86())
			goto skip; /* V86É^ÉXÉNÇ™égópíÜÇ»ÇÁêÿä∑Ç¶é∏îs */
...
void job_setvgamode3(const int sig, const int result)
{
	...
	// VESAÇÃÉmÉìÉTÉ|Å[ÉgÇ»Ç«Ç…ÇÊÇËÅAâÊñ ÉÇÅ[ÉhêÿÇËä∑Ç¶é∏îs
skip:
//	job.func = job_setvgamode3;
	#if (defined(BOCHS))
		screen.x2 = 640; /* BochsÇÕâºëzâÊñ Ç™égÇ¶Ç»Ç¢ */
...
void job_loadfont0(int fonttype, int tss, int sig)
{
	...
	/* ÉçÅ[ÉhÉRÅ[Éh */
	lib_initmodulehandle0(0x000c, 0x0200); /* machine-dirÇ…èâä˙âª */
...
void job_loadfont1(int flag, int dmy)
{
	...
	if ((pjob->fontflag & 0x01) == 0) {
		char *fp = (char *) pjob->readCSd10 /* mallocóÃàÊÇÃèIÇÌÇË == mappingóÃàÊÇÃénÇ‹ÇË */;
		if (flag == 0 /* ÉçÅ[Éhê¨å˜ */) {
			int siz = lib_readmodulesize(0x0200);
			lib_mapmodule(0x0000, 0x0200, 0x5, 320 * 1024, fp, 0);

			/* Ç±Ç±Ç≈slot:0x0210Ç…gapidataÇîzîı */
			/* ÉçÅ[ÉhÇ™èIÇÌÇ¡ÇƒÇ©ÇÁîzîıÇ∑ÇÈÇÃÇ™èdóvÇ≈ÅAÇªÇ§Ç≈Ç»Ç¢Ç∆gapidataÇÃägí£Ç™èIÇÌÇ¡ÇƒÇ»Ç¢Ç©Ç‡ÇµÇÍÇ»Ç¢Ç©ÇÁ */
			...
			lib_initmodulehandle0(0x000c, 0x0200); /* machine-dirÇ…èâä˙âª */
				...
				/* fontfileÉçÅ[ÉhÇ…é∏îsÇµÇΩÇÃÇ≈ROMÇóäÇÈ */
				sgg_execcmd0(0x007c, 0, 0x0210, 0x0000);
...
{
	struct STR_JOB *pjob = &job;
	if ((pjob->fontflag & 0x02) == 0 && flag == 0 /* ÉçÅ[Éhê¨å˜ */) {
		char *fp = (char *) pjob->readCSd10 /* mallocóÃàÊÇÃèIÇÌÇË == mappingóÃàÊÇÃénÇ‹ÇË */;
		int siz = lib_readmodulesize(0x0200);
		lib_mapmodule(0x0000, 0x0200, 0x5, 320 * 1024, fp, 0);
	...
	const int color, const int backcolor, const char *str)
{
	struct COMMAND {
		int cmd; /* 0x0048 */
		int opt /* ïKÇ∏0x0001Ç…Ç∑ÇÈ */;
		int window, charset /* ïKÇ∏0x00c0Ç…Ç∑ÇÈ */;
		int x0, y0 /* dotíPà  */;
		int color, backcolor;
		int length;
		int letters[80];
...
static int defsig_signal[4] /* , defsig_opt */; /* ÉTÉCÉYèkè¨ÇÃÇΩÇﬂ */
...
ÅEkeysignalíËã`Ç…Ç¬Ç¢Çƒ
  opt	bit 0-11 : òAë±íËã`ÉVÉOÉiÉãêî
		bit15	 : interval(+1Ç©+4Ç©)
		bit16-19 : make/break/remake/overbreak
				   Ç±ÇÍÇÕÅAägí£ÉÇÅ[ÉhÇ÷à⁄çsÇ∑ÇÈÇΩÇﬂÇ…ïKóv
				   Ç∑Ç◊ÇƒÇ0Ç…Ç∑ÇÈÇ∆ÅAmake|remakeÇ∆Ç¢Ç§Ç”Ç§Ç…àµÇÌÇÍÇÈ
				   Ç‡ÇøÇÎÇÒÅAÉCÉìÉNÉäÉÅÉìÉgÇÃï˚êjÇ∆ÇµÇƒÇ‡óòópÇ≥ÇÍÇÈ
				   ÉXÉ^Å[ÉgÇÕÅAkeycodeì‡ÇÃbit30-31Ç…èëÇ©ÇÍÇƒÇ¢ÇÈ
*/

}

void sgg_wm0_definesignal3sub(const int keycode)
/* òAë±éwíËÇÉTÉ|Å[ÉgÇµÇ»Ç¢ */
/* ÉfÉRÅ[ÉhÇÃÇ›(make/break/remakeÇÃîªíËÇÕÇµÇ»Ç¢) */
{
	static struct {
		int type0, type1;
	} shifttype[] = {
...
#if 0
	/* cmd, opt(len), rawÉRÅ[Éh, shift-lock-bitmap(mask, equal), subcmd,... */
	static struct {
		int cmd, length;
		int deccmd[10];
		int eoc;
...
ÅEkeysignalíËã`Ç…Ç¬Ç¢Çƒ
  opt	bit 0-11 : òAë±íËã`ÉVÉOÉiÉãêî
		...
		bit20-23 : ÉCÉìÉNÉäÉÅÉìÉgéûÇÃmake/break/remake/overbreak
				   ÉIÅ[Éã0Ç©Ç¬ÉCÉìÉNÉäÉÅÉìÉgÅAÇ∆Ç¢Ç§ÇÃÇÕãñÇ≥Ç»Ç¢
					bit16-23Ç™0ÇÃèÍçáÅAè]óàí ÇËÇÃàµÇ¢Ç…Ç»ÇÈ

  keycode bit12-14 : 000:ÉLÅ[ÉRÅ[ÉhéwíË
					 001:ÉRÅ[ÉhÇ≈ÇÕÇ»Ç≠ÉLÅ[éwíËÅiëÊàÍÉLÅ[Åj
					 010:ÉRÅ[ÉhÇ≈ÇÕÇ»Ç≠ÉLÅ[éwíËÅiëÊìÒÉLÅ[Åj
					 100:ÉRÅ[ÉhÇ≈ÇÕÇ»Ç≠ÉLÅ[éwíËÅiëÊéOÉLÅ[Åj
		  bit15    : bit16-31ÇÕóLå¯(bit12-14Ç™ÉmÉìÉ[ÉçÇ»ÇÁóLå¯Ç…åàÇ‹Ç¡ÇƒÇ¢ÇÈÇ∂Ç·Ç»Ç¢Ç©)
		  bit16-23 : shiftÉ}ÉXÉN
		  bit24-31 : shiftî‰är
*/
...
void gapi_loadankfont()
{
	...
	if (flag) { /* àÍìxì]ëóÇ∑ÇÍÇŒÇªÇÍÇ≈ÇÊÇ¢Ç©ÇÁ */
		sgg_execcmd(&command);
		flag = 0;
	}
	return;
...
#endif
    /* ï€ë∂êÊópà” */
    lib_initmodulehandle0(0x0008, 0x0200); /* user-dirÇ…èâä˙âª */
    job.func = &job_savevram1;
    lib_steppath0(1, 0x0200, "SCRNSHOT.BMP", 0x0050 /* sig */);
    return;
    /* SCRNSHOT.TIFÇÕ514KBà»è„Ç…Ç»ÇËÇ‹Ç∑ */
    /* éñëOÇ…ÉÇÉWÉÖÅ[ÉãÇçÏÇ¡ÇƒÇ®Ç©Ç»Ç≠ÇƒÇ‡Ç¢Ç¢Ç≈Ç∑ */
}
...
#if 0
/* BMÇÃå„Ç…ÉpÉfÉBÉìÉOÇ™ì¸ÇÈâ¬î\ê´! Ç«Ç§Ç‚Ç¡ÇƒñhÇÆÇÒÇæÇ¡ÇØ? */
struct bmphead {
  char BM[2];
...
void job_savevram2(int flag, int dmy)
{
  ...
  if (flag == 0 && 
    ...
    fi[5] = -screen.y2;		/* ÉgÉbÉvÉ_ÉEÉìäiî[ */
...
#elif (defined(TOWNS))
#if (defined(CLGD543X))
      if (screen.x2 == 800 && screen.y2 == 600) { /* CLGDÅcÅcéËî≤Ç´îªíË */
	fi[0] = 0xf800;		/* R */
	fi[1] = 0x07e0;		/* G */
	fi[2] = 0x001f;		/* B */
      } else
...
/* ï«éÜÉçÅ[ÉhÉãÅ[É`Éì, DLLÉoÅ[ÉWÉáÉì */
...
/* 2002.05.27 êÏçá : ï«éÜï\é¶Ç™ÉgÉOÉãÇ…Ç»ÇÈÇÊÇ§Ç…ïœçX */
{
	int bytepp = screen.vbecoldep;
	if (bytepp == 0)
	  bytepp++;
	if (screen.wallpaper_exist) {
	  job_loadwallpaper(-1, 0); /* âèú */
	  return;
	}
...
/* flag!=0Ç»ÇÁï«éÜÇ»Çµ, 0Ç»ÇÁopenê¨å˜ */
{
	...
	job_general1();		// job.now = 0; /* Å©Çä‹Çﬁ */
	return;
}
...
void putwallpaper(int x0, int y0, int x1, int y1)
/* 2002.05.27 êÏçá : x1, y1ÇÃílÇÃàµÇ¢ÇédólïœçX */
{
	int bytepp = screen.vbecoldep;
	if (bytepp)
		bytepp--;
...
struct WM0_WINDOW *searchwin(int x, int y)
// Ç«ÇÃwindowÇÉNÉäÉbÉNÇµÇΩÇÃÇ©Çåüèo
{
	struct WM0_WINDOW *win;
...
void job_vesacheck1(int sig, int result)
{
	...
	if ((buf[0] & 0x19) == 0x19) {
		...
		if (buf[2] >= 640 && buf[3] >= 480) { /* è¨Ç≥Ç∑Ç¨ÇÈâÊñ ÇÕÇ§Ç¡Ç∆Ç§ÇµÇ¢ÇÃÇ≈îrèú */
			if (buf[5] == 4 && buf[4] == 8)
